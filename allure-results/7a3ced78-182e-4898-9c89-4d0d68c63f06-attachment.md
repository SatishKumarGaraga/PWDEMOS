...
- main:
  ...
  - region "Notifications":
    ...
    - link "Attention. Can't launch a game or an app?. Some players may be having trouble launching games and apps. While we are working on a fix, try rebooting your console.":
      - text: Attention
      - heading "Can't launch a game or an app?" [level=3]
      - text: Some players may be having trouble launching games and apps. While we are working on a fix, try rebooting your console.
    - button "More options"
  ...
  - region "Explore gaming on Xbox":
    - heading "Explore gaming on Xbox" [level=2]
    - link "Put Xbox in your pocket and play on our mobile apps; 1 of 3":
      - img "Generic icons, mobile device illustrations, and a controller illustration from the console setup screen on the Xbox app."
      - heading "Put Xbox in your pocket and play on our mobile apps" [level=3]
    - link "Get connected with Xbox gaming accessories; 2 of 3":
      - heading "Get connected with Xbox gaming accessories" [level=3]
      - img "Illustration of a gamer wearing the Xbox Wireless Headset"
    - link "Optimize space by installing only the game features you want; 3 of 3":
      - heading "Optimize space by installing only the game features you want" [level=3]
      - img "A young player uses an Xbox controller to browse Xbox games on his TV monitor."
